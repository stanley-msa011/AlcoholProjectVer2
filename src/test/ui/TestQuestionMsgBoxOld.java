...
public class TestQuestionMsgBoxOld implements TestQuestionMsgBoxInterface{
	...
	public TestQuestionMsgBoxOld(Context context,GPSInterface gps,TestQuestionCaller testQuestionCaller,RelativeLayout mainLayout){
	...
	protected void setting(){
		...
		boxLayout = (RelativeLayout) inflater.inflate(R.layout.message_box_layout_old,null);
		...
		gpsSwitch = (CheckBox) boxLayout.findViewById(R.id.msg_gps_switch);
